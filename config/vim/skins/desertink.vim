...
" let s:TMU = [ '#ff8700', '#870000', 208,  88, 'bold' ] " modified unselected
" buffers
" let s:TH  = [ s:N1[1], s:N1[0], s:N1[3], s:N1[2] ]     " hidden buffers
"
" let g:airline#themes#desertink#palette = {}
"
" let g:airline#themes#desertink#palette.normal =
" airline#themes#generate_color_map(s:N1, s:N2, s:N3)
" let g:airline#themes#desertink#palette.normal_modified = {
"       \ 'airline_a': s:TM,
"             \ 'airline_z': s:TM }
"
"             let g:airline#themes#desertink#palette.insert =
"             airline#themes#generate_color_map(s:I1, s:I2, s:N3)
"             let g:airline#themes#desertink#palette.insert_replace = {
"                   \ 'airline_a': [ s:RE[0]   , s:I1[1]   , s:RE[1]   ,
"                   s:I1[3]   , ''     ],
"                         \ 'airline_z': [ s:RE[0]   , s:I1[1]   , s:RE[1]   ,
"                         s:I1[3]   , ''     ] }
"
"                         let g:airline#themes#desertink#palette.visual = {
"                               \ 'airline_a': [ s:V1[0]   , s:V1[1]   ,
"                               s:V1[2]   , s:V1[3]   , ''     ],
"                                     \ 'airline_z': [ s:V1[0]   , s:V1[1]   ,
"                                     s:V1[2]   , s:V1[3]   , ''     ] }
"
"                                     let
"                                     g:airline#themes#desertink#palette.replace
"                                     =
"                                     copy(airline#themes#desertink#palette.normal)
"                                     let
"                                     g:airline#themes#desertink#palette.replace.airline_a
"                                     = [ s:RE[0] , s:RE[1] , s:RE[2] ,
"                                     s:RE[3] , '' ]
"                                     let
"                                     g:airline#themes#desertink#palette.replace.airline_z
"                                     = [ s:RE[0] , s:RE[1] , s:RE[2] ,
"                                     s:RE[3] , '' ]
"
"                                     let
"                                     g:airline#themes#desertink#palette.inactive
"                                     =
"                                     airline#themes#generate_color_map(s:IA1,
"                                     s:IA2, s:IA3)
"
"                                     let
"                                     g:airline#themes#desertink#palette.tabline
"                                     = {
"                                           \ 'airline_tab': s:TH,
"                                                 \ 'airline_tabmod': s:TM,
"                                                       \
"                                                       'airline_tabmod_unsel':
"                                                       s:TMU,
"                                                             \
"                                                             'airline_tabhid':
"                                                             s:TN }
